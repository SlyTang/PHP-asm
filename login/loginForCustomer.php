<?php
    ...
    if(isset($_POST['user'],$_POST['password'])){
        ...
        $sql="select * from customer where customerEmail='$user' and password='$password'";
...
<div class = "mainContent">
    <form action="loginForCustomer.php" method="post">
        <h1>Customer Login</h1>
            ...
            <p>
                <center>
                    <a href="../customer/register.php">Click Here To Register Customer Account!</a>
                </center>
            </p>
    </form>
</div>
